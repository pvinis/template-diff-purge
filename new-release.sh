...
function generateProject () {
    # command to generate the new project for each release
    # eg:
    # npx react-native init "$ProjName" --version "$newRelease"
    # or
    # template init "$ProjName" --version "$newRelease"
}
...
function generateNewReleaseBranch () {
    # go to the base project branch
    git worktree add wt-app "$ProjBaseBranch"
    cd wt-app
